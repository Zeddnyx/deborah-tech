  ...
  return (
    <>
        <footer>
          <div className="col-span-3 lg:col-span-2 grid gap-3">
            ...
            <div className="text-[#d4d4d4] text-[14px]">
              Our Agency Software House Delivers one of kind applications only
              for your needs.
            </div>
            <ul className="text-[#fff] grid gap-3">
              <li>
                Graha Pena Lantai 15 ruang 1503 Jl. Ahmad Yani No. 88 RT / RW :
                003 / 007 Kel. Ketintang, Kec. Gayungan Surabaya 60231
              </li>
        ...
        <div className="text-center flex w-full bg-mainGray w-full justify-center py-2">
          <p>Deborah Tech © {new Date().getFullYear()} All right reserved</p>
        </div>
    </>
  );
}
