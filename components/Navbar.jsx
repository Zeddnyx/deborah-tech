...
export default function navbar() {
  ...
  return (
    <nav>
      ...
      <ul data-aos="fade-left" className="ul-nav">
        {nav.map((item, id) => (
          <li key={id} className='hover:text-textGray'>
      ...
      <div onClick={handleMenu} className='z-50 font-bold  text-surface md:hidden text-xl'>
